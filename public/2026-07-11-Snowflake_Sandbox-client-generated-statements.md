...
tags:
  ...
  - ウェアハウス
private: false
updated_at: '2026-07-12T20:11:46+09:00'
...
![Snowsightログイン直後のウェアハウス起動画面](./img_wh-resume-on-login.png)
...
![ウェアハウスは起動したのにクエリ履歴には何も出てこない](./img_no-query-history.png)
...
![クライアント生成クエリ検索条件](./img_client-generated-filter.png)

すると、先ほどは見えなかったクエリが出てきた。

![モニタリング画面からクエリを確認できた](./img_monitoring-query-found.png)
